import { Flex, rem, Text, Divider } from "@mantine/core";
...
export default function Page() {
  return (
    <Flex direction="column" m={rem(8)}>
      ...
      <Text>Sistemde müfredat ve dönemden önce bir ders eklenmesi gerek.</Text>
      ...
      <Text>
        Öğrenci eklemek için bir ön gereksinim yok. Öğrenci eklendikten sonra da
        bir veya birden fazla döneme atanılabilir.
      </Text>
      <Text>
        Öğrenci eklenince öğrenciye e-posta aracılığıyla davet linki gönderilir.
        Linke tıkladıktan sonra Kayıt sayfasına yönlendirilen öğrenci şifresini
        belirler ve kaydolur. Öğrencinin kayıt işlemini tamamlama durumu Admin
        tarafından görülebilir. Bu link sadece{" "}
        <Text span c="red">
          6 saat
        </Text>{" "}
        geçerlidir, zaman aşımına uğraması halinde öğrencinin yeniden eklenmesi
        gerekir.
      </Text>
      <Text>
